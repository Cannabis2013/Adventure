package GameEngine.MapGeneration.MapBuilders.SmallSquared.InitializeMap.MapDescriptions;
...
public class SpecialMapDescriptions {
    ...
    public String endGameDescription(){
        return "You enter a room with a stair that leads up to heaven " +
                "- at least that is what you hope for.";
    }

    public String bossRoomDescription(){
        return """
